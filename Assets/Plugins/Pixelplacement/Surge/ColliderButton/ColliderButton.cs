...
namespace Pixelplacement
{
    ...
    public sealed class ColliderButton : MonoBehaviour
    {
        ...
        private void ColorNormal()
        {
            ...
            if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color"))
            {
                _colorTweenMaterial = Tween.Color(colorRendererTarget, _normalColorRenderer, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }

            //tween image color:
            if (colorImageTarget != null)
            {
                Tween.Color(colorImageTarget, _normalColorImage, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }
        }
        ...
        private void ColorSelected()
        {
            ...
            if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color"))
            {
                _colorTweenMaterial = Tween.Color(colorRendererTarget, selectedColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }

            //tween image color:
            if (colorImageTarget != null)
            {
                Tween.Color(colorImageTarget, selectedColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }
        }
        ...
        private void ColorPressed()
        {
            ...
            if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color"))
            {
                _colorTweenMaterial = Tween.Color(colorRendererTarget, pressedColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }

            //tween image color:
            if (colorImageTarget != null)
            {
                Tween.Color(colorImageTarget, pressedColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }
        }
        ...
        private void ColorDisabled()
        {
            ...
            if (colorRendererTarget != null && colorRendererTarget.material.HasProperty("_Color"))
            {
                _colorTweenMaterial = Tween.Color(colorRendererTarget, disabledColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }

            //tween image color:
            if (colorImageTarget != null)
            {
                Tween.Color(colorImageTarget, disabledColor, colorDuration, 0, null, null, Tween.LoopType.None, null, null, false);
            }
        }
        ...
        private void ScaleNormal()
        {
            ...
            _scaleTween = Tween.LocalScale(scaleTarget, normalScale, scaleDuration, 0, curve, null, Tween.LoopType.None, null, null, false);
        }
        ...
        private void ScaleSelected()
        {
            ...
            _scaleTween = Tween.LocalScale(scaleTarget, Vector3.Scale(normalScale, selectedScale), scaleDuration, 0, curve, null, Tween.LoopType.None, null, null, false);
        }
        ...
        private void ScalePressed()
        {
            ...
            _scaleTween = Tween.LocalScale(scaleTarget, Vector3.Scale(normalScale, pressedScale), scaleDuration, 0, curve, null, Tween.LoopType.None, null, null, false);
        }
    }
}