...
namespace Pixelplacement.TweenSystem
{
    public abstract class TweenBase
    {
        ...
        public void Tick ()
        {
            ...
            else if (EaseFunc != null) curveValue = EaseFunc(curveValue);
        ...
        /// </summary>
        protected void SetEssentials (Tween.TweenType tweenType, int targetInstanceID, float duration, float delay, bool obeyTimeScale, AnimationCurve curve, Func<float, float> easeFunc, Tween.LoopType loop, Action startCallback, Action completeCallback)
        {
