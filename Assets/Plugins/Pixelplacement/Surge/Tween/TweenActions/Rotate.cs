...
namespace Pixelplacement.TweenSystem
{
    class Rotate : TweenBase
    {
        ...
        //Constructor:
        public Rotate (Transform target, Vector3 endValue, Space space, float duration, float delay, bool obeyTimescale, AnimationCurve curve, Func<float, float> easeFunc, Tween.LoopType loop, Action startCallback, Action completeCallback)
        {
